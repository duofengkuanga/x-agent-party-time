...
export function LoginForm({
  ...
  function chooseAccount(account: LoginAccount): void {
    ...
    <main className="auth-shell" data-theme={theme}>
      <header className="auth-topbar">
        <div className="auth-brand-lockup">
          <span className="auth-brand">
            Agent Party <span className="auth-stamp">Time</span>
          </span>
          <span
      ...
      <div className="auth-stage">
        <section className="auth-manifesto">
          <h1 aria-label="the agents is having a party">
